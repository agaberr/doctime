                        ...
                        <div className="md:col-span-2">
                            <div className="flex items-center gap-5">
                                ...
                                <div className="flex items-center gap-[6px]">
                                    ...
                                    <span className="text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-black">
                                        (222)
                                    </span>
                                </div>
                                <p className="text-[14px] leading-5 md:text-[15px] max-w-[390px]">
                                    lorem is one of the most movement and doctor are used original toolkit text.
                                </p>
                            </div>
